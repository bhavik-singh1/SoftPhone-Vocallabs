...
VARS='${TRUNK_HOST} ${TRUNK_PORT} ${TRUNK_USERNAME} ${TRUNK_PASSWORD} ${TRUNK_PREFIX} ${TRUNK_CALLER_ID} ${INBOUND_USERNAME} ${INBOUND_PASSWORD} ${INBOUND_DID} ${SOFTPHONE_USER} ${SOFTPHONE_PASSWORD} ${AMI_USER} ${AMI_PASSWORD} ${PUBLIC_IP} ${METERED_TURN_USER} ${METERED_TURN_CRED}'
