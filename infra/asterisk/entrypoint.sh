...
VARS='${TRUNK_HOST} ${TRUNK_PORT} ${TRUNK_USERNAME} ${TRUNK_PASSWORD} ${TRUNK_PREFIX} ${TRUNK_CALLER_ID} ${SOFTPHONE_USER} ${SOFTPHONE_PASSWORD} ${AMI_USER} ${AMI_PASSWORD} ${PUBLIC_IP}'
