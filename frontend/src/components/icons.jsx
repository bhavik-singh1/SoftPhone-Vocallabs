...
// Lucide-style line icons (24px grid, 2px stroke, round caps). Inline so we
// ship no icon dependency and can tint via currentColor. Each takes an optional
// `size` and spreads the rest onto <svg> (className, etc).
...
export const PhoneIncomingIcon = (p) => (
  <Svg {...p}>
...
export const PhoneOutgoingIcon = (p) => (
  <Svg {...p}>
...
export const PhoneMissedIcon = (p) => (
  <Svg {...p}>
